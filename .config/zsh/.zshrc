...
# Enable this as part of this solution: 
# This is necessary when: source ~/.zshrc 
# A message is prompt as - Insecure completion-dependent 
# The formal solution is explained here 
# https://github.com/ohmyzsh/ohmyzsh/issues/6835#issuecomment-390216875 f
...
HISTSIZE=10000
HISTFILE=${ZDOTDIR:-$HOME/.config/zsh}/.zsh_history # File
...
# To customize prompt, run `p10k configure` or edit ${ZDOTDIR:-$HOME/.config/zsh}/.p10k.zsh.
...
# For more details into errors check 
export LDFLAGS="-L$(brew --prefix openssl)/lib -L$(brew --prefix readline)/lib -L$(brew --prefix zlib)/lib -L$(brew --prefix tcl-tk)/lib"
