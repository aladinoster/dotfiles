# Generated by Powerlevel10k configuration wizard on 2020-01-20 at 00:41 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 31836.
# Wizard options: awesome-patched + powerline, small icons, rainbow, time,
# angled separators, sharp heads, blurred tails, 2 lines, dotted, full frame, dark,
